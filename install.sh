...
readonly setup_repo="https://github.com/chelaxian/Byedpi-Setup/archive/refs/heads/main.zip"
...
Documentation=https://github.com/chelaxian/Byedpi-Setup
...
EOF
    ...
    echo -e "\e[36m"
    echo "Byedpi-Setup"
    echo "github.com/chelaxian/Byedpi-Setup"
    echo -e "\e[0m"
    sleep 2
    check_dependencies
